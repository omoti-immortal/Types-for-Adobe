 ...
 */
declare class PageItems extends Object  {
	/**
	 * Number of elements in the collection.
	 */
	length: number;
...
declare class FXGSaveOptions {
	 ...
	 * Legacy Item and Do not use any more.
	 */
...
declare class Application {
	 ...
	 * @param aiMenu Menu command shortcut.
	 */
	executeMenuCommand(aiMenu: String): void;
...
declare enum PerspectiveGridType {
	OnePointPerspectiveGridType = 1,
	TwoPointPerspectiveGridType = 2,
	ThreePointPerspectiveGridType =3,
	InvalidPerspectiveGridType = 0
}
