...
declare class TextFrameItems {
	 ...
	 * @param orientation The orientation of the text.
	 */
	pointText(anchor: [number, number], orientation?: TextOrientation): TextFrameItem;
...
declare class Application {
	 ...
	 */
	openCloudLibraryAssetForEditing(assetURL: File, thumbnailURL: File, assetType: string, options?: any): Document;
...
declare class Document {
	 ...
	 */
	convertCoordinate(coordinate: [number, number], source: CoordinateSystem, destination: CoordinateSystem): [number, number];
	 ...
	 */
	exportForScreens(exportFolder: File, exportFormat: ExportForScreensType, options?: any, itemToExport?: ExportForScreensItemToExport, fileNamePrefix?: string): void;
	 ...
	 */
	importFile(importFile: File, isLinked: boolean, libraryName?: string, itemName?: string, elementRef?: string, modifiedTime?: number, creationTime?: number, adobeStockId?: string, adobeStockLicense?: string, shouldLoadToPlaceGun?: boolean): void;
